# Let me create a comprehensive Python program that monitors log files for Cloudflare tunnel URLs
# and automatically shortens them using pyshortener and sends to Discord webhooks
...
with open('tunnel_url_monitor.py', 'w') as f:
    f.write(program_code)

print("✅ Created tunnel_url_monitor.py")
print("📦 Required packages: pyshorteners, watchdog, requests")
print("🔧 Usage examples:")
print("  1. python tunnel_url_monitor.py                    # Start monitoring")
print("  2. python tunnel_url_monitor.py --test-webhook     # Test Discord webhook")
print("  3. python tunnel_url_monitor.py --test-file log.txt # Test URL extraction")